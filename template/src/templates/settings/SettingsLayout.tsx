...
import bodewellLogo from '../../assets/orange.png';
    ...
    <>
      <SidebarHeader>
        ...
        <div className={`flex items-center w-full h-full ${isOpen ? 'justify-between' : 'justify-end'}`}>
          ...
          >
            <img src={bodewellLogo} alt="Bodewell Logo" className="h-7 w-auto" />
            <span className="text-xl font-bold text-text">Bodewell</span>
          </Link>
