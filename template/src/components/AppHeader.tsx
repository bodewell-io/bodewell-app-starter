 ...
 * 1. Updated logo to include both the `orange.png` image and "Bodewell" text.
...
import bodewellLogo from '../assets/orange.png'; // <-- 1. IMPORT THE LOGO
  ...
  return (
    ...
    <header className="flex items-center justify-between p-4 bg-card border-b border-border shadow-sm sticky top-0 z-50">
      ...
      <Link to="/dashboard" className="flex items-center gap-2">
        <img src={bodewellLogo} alt="Bodewell Logo" className="h-8 w-auto" />
