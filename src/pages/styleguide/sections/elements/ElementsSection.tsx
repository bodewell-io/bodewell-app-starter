...
const AvatarsSection = memo(() => (
  <Card id="elements-avatars" className="scroll-mt-20">
    ...
    <div className="flex flex-wrap items-center gap-4">
      ...
      <Avatar name="Bodewell UI" src="https://github.com/bodewell-io.png" size="lg" />
    </div>
  </Card>
));

const BadgesSection = memo(() => (
  <Card id="elements-badges" className="scroll-mt-20">
...
const StatCardsSection = memo(() => (
  <Card id="elements-stats" className="scroll-mt-20">
...
const ActivityFeedSection = memo(() => (
  <Card id="elements-activity" className="scroll-mt-20">
...
const ElementsSection: React.FC = () => {
  ...
  return (
   <div className="space-y-8">
      ...
      <Card id="elements-toggle" className="scroll-mt-20">
