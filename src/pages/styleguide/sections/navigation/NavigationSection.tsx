...
const NavigationSection: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card id="navigation-stepper" className="scroll-mt-20">
      ...
      <Card id="navigation-tabs" className="scroll-mt-20">
      ...
      <Card id="navigation-menus" className="scroll-mt-20">
      ...
      <Card id="navigation-breadcrumbs" className="scroll-mt-20">
