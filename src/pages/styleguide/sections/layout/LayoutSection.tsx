...
const LayoutSection: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Theme Info */}
      <Card id="layout-theme"  className="scroll-mt-20">
      ...
      {/* Typography */}
      <Card id="layout-typography" className="scroll-mt-20">
      ...
      {/* Card Examples */}
      <Card id="layout-card" className="scroll-mt-20">
      ...
      {/* Modals */}
      <Card id="layout-modal" className="scroll-mt-20">
      ...
      {/* Drawers */}
      <Card id="layout-drawer" className="scroll-mt-20">
      ...
      {/* Accordion */}
      <Card id="layout-accordion" className="scroll-mt-20">
        ...
        <Accordion>
          ...
          <AccordionItem id="item2" header="Section 2: How do I use it?"><p className="p-4 text-text">Simply use `npm create bodewell-app@latest` to start a new project. Explore this Style Guide for component examples.</p></AccordionItem>
        </Accordion>
      </Card>
    </div>
  );
