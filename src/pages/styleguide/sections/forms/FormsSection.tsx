...
const FormsSection: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card id="form-buttons" className="scroll-mt-20">
      ...
      <Card id="form-inputs" className="scroll-mt-20">
      ...
      <Card id="form-select" className="scroll-mt-20">
      ...
      <Card id="form-advanced" className="scroll-mt-20">
      ...
      <Card id="form-upload" className="scroll-mt-20">
      ...
      <div id="form-template" className="scroll-mt-20">
        <FormTemplate
