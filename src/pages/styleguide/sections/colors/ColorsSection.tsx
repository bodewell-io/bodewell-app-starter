...
import { Card, SectionHeader } from '@bodewell/ui';
...
const ColorsSection: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card id="colors-theme" className="scroll-mt-20">
        <h3 className="text-2xl font-semibold mb-2 text-text">Themed Color Palette</h3>
        <p className="text-muted-foreground mb-8">
          These colors are defined by the current theme and will change dynamically when you switch themes.
        </p>
      ...
      <Card id="colors-tailwind" className="scroll-mt-20">
